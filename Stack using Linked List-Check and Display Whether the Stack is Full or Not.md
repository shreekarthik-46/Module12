# 12)c)  Stack using Linked List: Check and Display Whether the Stack is Full or Not
...
## Sample Input & Output
![stack-check](https://github.com/user-attachments/assets/923479cb-65ae-4f15-a3bf-2157425fb0e7)
...
Creates a stack with a fixed size.
  Adds elements to the stack.
  Checks if the stack is full.
  Displays a message indicating whether the stack is full or not is created.
